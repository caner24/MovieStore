    ...
    public partial class mig_1_db_created : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KindMovie", x => new { x.KindsId, x.MoviesId });
                    table.ForeignKey(
                        name: "FK_KindMovie_Kind_KindsId",
                        column: x => x.KindsId,
                        principalTable: "Kind",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KindMovie_Movie_MoviesId",
                        column: x => x.MoviesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerKind_FavoriteKindId",
                table: "CustomerKind",
                column: "FavoriteKindId");

            migrationBuilder.CreateIndex(
                name: "IX_KindMovie_MoviesId",
                table: "KindMovie",
                column: "MoviesId");
